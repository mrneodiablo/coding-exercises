...
write a function remove_element that removes all occurrences of
val in the list in-place and returns the new length of the modified list.

The function should not allocate extra space for another list;
instead, it should modify the input list in-place with O(1) extra memory.
...
An integer representing the new length of the modified
list after removing all occurrences of val.
...
It is okay to have extra space at the end of
the modified list after removing elements.
"""
...
# Test case 1: Removing a single instance of
# a value (1) in the middle of the list.
